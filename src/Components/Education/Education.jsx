        ...
        <Box sx={{ flexGrow: 1 }} class="flex">
          ...
          >
            <Grid xs={10} md={10} className='education'>
              ...
              <h2>
                <a href="https://usindh.edu.pk/" className="eduTitle" style={{color: 'blueviolet'}}>University of Sindh</a>
              </h2>
              ...
              <h2>
                <a href="https://www.gcuh.edu.pk/" className="eduTitle"style={{color: 'blueviolet'}}>Government College University</a>
              </h2>
              <h3>Intermediate in Pre-Engineering</h3>
              <p>January 2015 - December 2017</p>
              <div id="divider"></div>
            </Grid>
          </Grid>
        </Box>
