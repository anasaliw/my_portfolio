  ...
  return (
    ...
    <Router>
      <nav>
        ...
        <ul className={ state ? "desktopNav" : "mobileNav"}>
        <img src="../../Images/signature.png" className="signature" alt="" />

          <Link to="/home"><li>Home</li></Link>
          <Link to="/project" onClick={scrollToProject} duration={50} smooth={false} > <li>Project</li> </Link>
          <Link to="/skills" onClick={scrollToSkill} duration={50} smooth={false} > <li>Skills</li> </Link>
          <Link to="/contact" onClick={scrollToContact} duration={50} smooth={false} > <li>Contact Me</li> </Link>
